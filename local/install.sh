...
# @description This script will install Ansibler. The script heavily borrows from
...
#
#   ```
#   curl -sSL https://raw.githubusercontent.com/megabyte-labs/ansibler/master/local/install.sh | sh
#   ```

RELEASES_URL="https://github.com/megabyte-labs/ansibler/releases"
